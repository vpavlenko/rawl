...
const HorizontalScaleScrollBar_: StatelessComponent<HorizontalScaleScrollBar_Props> = (props) => {
  ...
  return <ScrollBar isVertical={false} {...props} barLength={barLength} style={{
    width: "100%",
    height: BAR_WIDTH,
    position: "absolute",
    bottom: 0,
...
export type HorizontalScaleScrollBarProps = Omit<HorizontalScaleScrollBar_Props, "size">
