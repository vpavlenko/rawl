...
const TOP_100_COMPOSERS: { slug: string; composer: string; order?: number }[] =
  [
    ...
    { slug: "Golden_Hour__JVKE_Updated_Ver.", composer: "JVKE", order: 2030 },
    {
    ...
    { slug: "Hallelujah", composer: "Leonard Cohen", order: 1550 },
    { slug: "Interstellar", composer: "Hans Zimmer", order: 1890 },
    {
    ...
    { slug: "my-heart-will-go-on", composer: "James Horner", order: 2480 },
    {
    ...
    { slug: "Viva_La_Vida_Coldplay", composer: "Coldplay", order: 370 },
    ...
    { slug: "Bella_Ciao", composer: "Italian folk", order: 1450 },
    {
    ...
    { slug: "Pokemon_Theme_Song", composer: "John Siegler", order: 1870 },
